...
This repository archives the publicly published Terms of Use of NextEra
Energy, Inc., per ADR-2607110300 -- a read-only reference archive. As part
...
- **Company**: NextEra Energy, Inc., LEI 254900RHL9MEUS5NKX63, website
  `https://www.nexteraenergy.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url
  `https://www.nexteraenergy.com/legal-notice.html`, retrieved-at
