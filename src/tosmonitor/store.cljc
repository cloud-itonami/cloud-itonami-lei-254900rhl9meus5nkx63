(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (NextEra Energy, Inc., LEI
  254900RHL9MEUS5NKX63) -- unlike `commitledger.store`'s multi-application
...
(defn demo-company []
  {:legal-name "NextEra Energy, Inc."
   :website    "https://www.nexteraenergy.com"})

(def ^:private demo-full-text
  "Legal Notice\nThis Legal Notice governs your access to and use of the NextEra Energy, Inc. website. By using this site you agree to these terms, which may change without notice. This agreement is governed by the laws of the State of Florida.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.nexteraenergy.com/legal-notice.html"
